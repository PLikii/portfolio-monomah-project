    ...
    <div className="gap-4 px-6 py-8 xl:grid xl:grid-cols-2 lg:px-14 xl:px-24">
      <div className="space-y-8" data-aos="fade-right">
        <div className="text-center font-bold text-3xl text-primary md:text-left xl:text-5xl">
          The principle of operation of a solar station{" "}
        </div>

        <p>
          You consume electricity, you have a roof/parking lot/land plot, you have the opportunity to integrate a solar
          station into your own energy system.
        </p>
        <p>
          Due to the simple principle of operation, affordable cost of equipment and work of our specialists, you will
          receive your own generating plant, which will provide your production, warehouse, shopping mall, medical
          facility, gas station, service station, shop, farm or other industrial complex with free electricity from the
          sun for decades.
        </p>
