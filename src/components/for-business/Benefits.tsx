    ...
    <div>
      <div className="gap-4 px-6 py-8 xl:grid xl:grid-cols-2 lg:px-14 xl:px-24">
        <div className="space-y-8" data-aos="fade-right">
          <div className="text-center font-bold text-3xl text-primary md:text-left xl:text-5xl">Вигоди СЕС мереж</div>
          ...
          <p>
            За рахунок простого принципу роботи, доступної вартості обладнання та роботи наших спеціалістів, Ви
            отримаєте власну генеруючу установку, яка буде забезпечувати Ваше виробництво, складське приміщення, ТРЦ,
            медичний заклад, АЗС, СТО, магазин, ферму чи інший промисловий комплекс, безкоштовною електроенергією від
            сонця протягом десятиліть
          </p>
